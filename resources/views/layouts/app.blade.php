...
<head>
  ...
  <!-- slick slider -->
  <link rel="stylesheet" href="{{ asset('admin/plugins/slick/slick.css') }}">
  <!-- themefy-icon -->
  <link rel="stylesheet" href="{{ asset('admin/plugins/themify-icons/themify-icons.css')}}">
  <!-- animation css -->
  <link rel="stylesheet" href="{{ asset('admin/plugins/animate/animate.css') }}">
  <!-- aos -->
  <link rel="stylesheet" href="{{ asset('admin/plugins/aos/aos.css') }}">
  <!-- venobox popup -->
  <link rel="stylesheet" href="{{ asset('admin/plugins/venobox/venobox.css') }}">
          ...
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item dropdown view">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="{{route('blog')}}">Blog Details</a>
              </div>
            </li>
